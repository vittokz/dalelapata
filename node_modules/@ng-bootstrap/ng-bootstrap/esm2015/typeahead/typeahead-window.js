...
function NgbTypeaheadWindow_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const result_r201 = ctx.result;
    const term_r202 = ctx.term;
    const formatter_r203 = ctx.formatter;
    ɵngcc0.ɵɵproperty("result", formatter_r203(result_r201))("term", term_r202);
} }
...
function NgbTypeaheadWindow_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function NgbTypeaheadWindow_ng_template_2_Template_button_mouseenter_0_listener() { ɵngcc0.ɵɵrestoreView(_r208); const idx_r205 = ctx.index; const ctx_r207 = ɵngcc0.ɵɵnextContext(); return ctx_r207.markActive(idx_r205); })("click", function NgbTypeaheadWindow_ng_template_2_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r208); const result_r204 = ctx.$implicit; const ctx_r209 = ɵngcc0.ɵɵnextContext(); return ctx_r209.select(result_r204); });
    ɵngcc0.ɵɵtemplate(1, NgbTypeaheadWindow_ng_template_2_ng_template_1_Template, 0, 0, "ng-template", 4);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const result_r204 = ctx.$implicit;
    const idx_r205 = ctx.index;
    const ctx_r200 = ɵngcc0.ɵɵnextContext();
    const _r198 = ɵngcc0.ɵɵreference(1);
    ɵngcc0.ɵɵclassProp("active", idx_r205 === ctx_r200.activeIdx);
    ɵngcc0.ɵɵproperty("id", ctx_r200.id + "-" + idx_r205);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r200.resultTemplate || _r198)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(5, _c0, result_r204, ctx_r200.term, ctx_r200.formatter));
} }
