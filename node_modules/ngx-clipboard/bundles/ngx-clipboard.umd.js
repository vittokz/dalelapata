(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/common'), require('@angular/core'), require('ngx-window-token'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('ngx-clipboard', ['@angular/core','@angular/common','exports', '@angular/common', '@angular/core', 'ngx-window-token', 'rxjs'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-clipboard'] = {}, global.ng.common, global.ng.core, global.ngxWindowToken, global.rxjs));
}(this, (function (ɵngcc0,ɵngcc1,exports, common, core, ngxWindowToken, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ClipboardService = /** @class */ (function () {
        ...
        ClipboardService = __decorate([ __param(0, core.Inject(common.DOCUMENT)), __param(1, core.Optional()), __param(1, core.Inject(ngxWindowToken.WINDOW))
        ], ClipboardService);
ClipboardService.ɵfac = function ClipboardService_Factory(t) { return new (t || ClipboardService)(ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(ngxWindowToken.WINDOW, 8)); };
...
ClipboardModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ClipboardModule_Factory(t) { return new (t || ClipboardModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ClipboardModule, { declarations: [ClipboardDirective,
        ClipboardIfSupportedDirective], imports: [ɵngcc1.CommonModule], exports: [ClipboardDirective,
