...
var TileView = CollectionWidget.inherit({
    ...
    _renderContentSize: function(config, itemMargin) {
        if (windowUtils.hasWindow()) {
            var actualContentSize = this._cells.length * this.option(config.baseItemMainDimension) + (this._cells.length + 1) * itemMargin;
            var containerSize = this._$container[config.mainDimension]();
