...
var BaseRenderingStrategy = function() {
    ...
    _createClass(BaseRenderingStrategy, [{
        ...
        value: function(item, currentItem, orientation) {
            ...
            var isItemCross = Math.abs(item[orientation[2]] - currentItem[orientation[2]]) <= 1;
            return isItemCross && !!item.allDay === !!currentItem.allDay && (side_1 <= currentItem[orientation[0]] && side_2 > currentItem[orientation[0]] || side_1 < currentItem[orientation[1]] && side_2 >= currentItem[orientation[1]] || side_1 === currentItem[orientation[0]] && side_2 === currentItem[orientation[1]])
        }
    }, {
        key: "_getOrientation",
        value: function() {
