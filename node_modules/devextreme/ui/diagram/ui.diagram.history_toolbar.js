...
var DiagramHistoryToolbar = function(_DiagramToolbar) {
    _inherits(DiagramHistoryToolbar, _DiagramToolbar);
    var _super = _createSuper(DiagramHistoryToolbar);

    function DiagramHistoryToolbar() {
        _classCallCheck(this, DiagramHistoryToolbar);
        return _super.apply(this, arguments)
    }
    _createClass(DiagramHistoryToolbar, [{
        key: "_getCommands",
        value: function() {
            return _diagram2.default.getHistoryToolbarCommands(this.option("commands"), this._getExcludeCommands())
        }
    }, {
        ...
        value: function() {
            ...
            if (!this.option("isMobileView")) {
                commands.push(_diagram2.default.SHOW_TOOLBOX_COMMAND_NAME)
            }
            return commands
        }
    }]);
