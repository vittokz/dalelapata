...
var DiagramPropertiesToolbar = function(_DiagramToolbar) {
    _inherits(DiagramPropertiesToolbar, _DiagramToolbar);
    var _super = _createSuper(DiagramPropertiesToolbar);

    function DiagramPropertiesToolbar() {
        _classCallCheck(this, DiagramPropertiesToolbar);
        return _super.apply(this, arguments)
    }
    _createClass(DiagramPropertiesToolbar, [{
        key: "_getCommands",
        value: function() {
            return _diagram2.default.getPropertiesToolbarCommands()
        }
    }]);
