...
var Img = (function (_super) {
    ...
    function Img(url, fromDefinition) {
        if (fromDefinition === void 0) { fromDefinition = false; }
    ...
    Img.prototype.toBase64 = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(/^data:image\/(jpeg|png|jpg);base64,/.test(this.url) || this.fromDefinition)) return [3, 1];
                        this.content.image = this.url;
                        return [2, Promise.resolve(this.content)];
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        _a = this.content;
