(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('devextreme-angular/core'),require('@angular/platform-browser'),exports, require('@angular/platform-browser'), require('@angular/core'), require('devextreme/ui/progress_bar'), require('@angular/forms'), require('devextreme-angular/core')) :
    typeof define === 'function' && define.amd ? define('devextreme-angular/ui/progress-bar', ['@angular/core','devextreme-angular/core','@angular/platform-browser','exports', '@angular/platform-browser', '@angular/core', 'devextreme/ui/progress_bar', '@angular/forms', 'devextreme-angular/core'], factory) :
    (global = global || self, factory(global.ng.core,global.devextremeAngular.core,global.ng.platformBrowser,(global['devextreme-angular'] = global['devextreme-angular'] || {}, global['devextreme-angular'].ui = global['devextreme-angular'].ui || {}, global['devextreme-angular'].ui['progress-bar'] = {}), global.ng.platformBrowser, global.ng.core, global.DxProgressBar, global.ng.forms, global['devextreme-angular'].core));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, platformBrowser, core, DxProgressBar, forms, core$1) { 'use strict';

    DxProgressBar = DxProgressBar && Object.prototype.hasOwnProperty.call(DxProgressBar, 'default') ? DxProgressBar['default'] : DxProgressBar;
    ...
    ***************************************************************************** */
    ...
    var DxProgressBarComponent = /** @class */ (function (_super) {
        ...
        DxProgressBarComponent = __decorate([ __param(7, core.Inject(core.PLATFORM_ID)),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DxProgressBarModule, { declarations: [DxProgressBarComponent], imports: [ɵngcc1.DxIntegrationModule, ɵngcc1.DxTemplateModule, ɵngcc2.BrowserTransferStateModule], exports: [DxProgressBarComponent, ɵngcc1.DxTemplateModule] }); })();
