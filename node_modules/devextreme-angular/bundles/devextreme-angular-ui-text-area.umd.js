(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('devextreme-angular/core'),require('@angular/platform-browser'),exports, require('@angular/platform-browser'), require('@angular/core'), require('devextreme/ui/text_area'), require('@angular/forms'), require('devextreme-angular/core')) :
    typeof define === 'function' && define.amd ? define('devextreme-angular/ui/text-area', ['@angular/core','devextreme-angular/core','@angular/platform-browser','exports', '@angular/platform-browser', '@angular/core', 'devextreme/ui/text_area', '@angular/forms', 'devextreme-angular/core'], factory) :
    (global = global || self, factory(global.ng.core,global.devextremeAngular.core,global.ng.platformBrowser,(global['devextreme-angular'] = global['devextreme-angular'] || {}, global['devextreme-angular'].ui = global['devextreme-angular'].ui || {}, global['devextreme-angular'].ui['text-area'] = {}), global.ng.platformBrowser, global.ng.core, global.DxTextArea, global.ng.forms, global['devextreme-angular'].core));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, platformBrowser, core, DxTextArea, forms, core$1) { 'use strict';

    DxTextArea = DxTextArea && Object.prototype.hasOwnProperty.call(DxTextArea, 'default') ? DxTextArea['default'] : DxTextArea;
    ...
    ***************************************************************************** */
    ...
    var DxTextAreaComponent = /** @class */ (function (_super) {
        ...
        DxTextAreaComponent = __decorate([ __param(7, core.Inject(core.PLATFORM_ID)),
...
DxTextAreaComponent.ɵfac = function DxTextAreaComponent_Factory(t) { return new (t || DxTextAreaComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DxTemplateHost), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.WatcherHelper), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.IterableDifferHelper), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.NestedOptionHost), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.TransferState), ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID)); };
DxTextAreaComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxTextAreaComponent, selectors: [["dx-text-area"]], hostBindings: function DxTextAreaComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("valueChange", function DxTextAreaComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); })("onBlur", function DxTextAreaComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DxTextAreaModule, { declarations: [DxTextAreaComponent], imports: [ɵngcc1.DxIntegrationModule, ɵngcc1.DxTemplateModule, ɵngcc2.BrowserTransferStateModule], exports: [DxTextAreaComponent, ɵngcc1.DxTemplateModule] }); })();
