...
DxRecurrenceEditorComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxRecurrenceEditorComponent, selectors: [["dx-recurrence-editor"]], hostBindings: function DxRecurrenceEditorComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("onBlur", function DxRecurrenceEditorComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxRecurrenceEditorComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
