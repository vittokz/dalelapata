...
DxSelectBoxComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxSelectBoxComponent, selectors: [["dx-select-box"]], contentQueries: function DxSelectBoxComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("onBlur", function DxSelectBoxComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxSelectBoxComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
