...
DxProgressBarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxProgressBarComponent, selectors: [["dx-progress-bar"]], hostBindings: function DxProgressBarComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("onBlur", function DxProgressBarComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxProgressBarComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
...
DxProgressBarComponent = __decorate([ __param(7, Inject(PLATFORM_ID)),
