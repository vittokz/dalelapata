...
DxCalendarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxCalendarComponent, selectors: [["dx-calendar"]], hostBindings: function DxCalendarComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("onBlur", function DxCalendarComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxCalendarComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
