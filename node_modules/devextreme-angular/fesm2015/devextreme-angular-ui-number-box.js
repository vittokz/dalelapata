...
DxNumberBoxComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxNumberBoxComponent, selectors: [["dx-number-box"]], contentQueries: function DxNumberBoxComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("onBlur", function DxNumberBoxComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxNumberBoxComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
