...
DxDateBoxComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxDateBoxComponent, selectors: [["dx-date-box"]], contentQueries: function DxDateBoxComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("onBlur", function DxDateBoxComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxDateBoxComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
