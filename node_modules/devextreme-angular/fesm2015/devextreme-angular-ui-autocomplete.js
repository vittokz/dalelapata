...
DxAutocompleteComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DxAutocompleteComponent, selectors: [["dx-autocomplete"]], contentQueries: function DxAutocompleteComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("onBlur", function DxAutocompleteComponent_onBlur_HostBindingHandler($event) { return ctx.touched($event); })("valueChange", function DxAutocompleteComponent_valueChange_HostBindingHandler($event) { return ctx.change($event); });
