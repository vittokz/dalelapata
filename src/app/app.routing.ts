...
const routes: Routes =[
  ...
  {
    path: 'detalle-noticia',component: DetalleNoticiaComponent
  },
  {
  ...
  {
    path: 'detalle-evento/:parametro',component: DetalleEventoComponent
  },{
    path: 'fauna-silvestre',component: FaunaSilvestreComponent
  },
  {
    path: 'pagEventos',component: PagEventosComponent
  },
  {
    path: 'pagDetalleNoticias',component: PagDetalleFaunaComponent
  },
  {
    path: 'pagDetalleEventos/:idEvento',component: PagDetalleEventoComponent
  },
  {
  ...
  {
    path: 'lista-fundaciones',component: ListarFundacionesComponent 
  },
  {
    path: 'detalle-fundacion',component: DetalleFundacionComponent
  },
  {
    path: 'login-Admin', component: LoginAdminComponent
  },
  {
    path: 'fundacionPorUsuario', component: FundacionUsuariosComponent
  },
  {
    path: 'listar-Usuarios', component: ListarUsuariosComponent
  },
  {
    path: 'listar-UsuariosPlataforma', component: ListarComponent
  },
  {
    path: 'buscarChip', component:  PaginaMicrochipComponent   
  },
  {
    path: 'pagAdopcion', component:  PrincipalComponent 
  },
  {
    path: 'lista-adoptadas', component:  ListaAdoptadasComponent 
  },
  {
    path: 'lista-esterilizadas', component: ListaEsterilizadasComponent 
  },
  {
  ...
  {
    path: 'detalleMascotaWeb/:parametro', component: DetalleMascotaWebComponent
  },
  {
  ...
  {
    path: 'registrarUsuarios', component: RegistrarseComponent
  },
  {
    path: 'registrarFundacion', component: RegistrarFundacionComponent
  },
  {
    path: 'detalleUsuarioPag/:parametro/:parametro2', component: DetalleUsuarioPagComponent
},
{
  path: 'detalleMascotaAdoptada/:parametro', component: DetalleMascotaAdoptadaComponent 
},
  {
    path: 'perfil-usuario', component: PerfilPagComponent
  },
  {
    path: 'registrar-mascota', component: RegistrarMascotaComponent
  },
  {
    path: 'administrar-perfil', component: AdminComponent
  },
  {
    path: 'usuarios-perfil', component: UsuariosAdminComponent
  },
  {
    path: 'postulaciones', component: PostulacionesComponent 
  },
  {
    path: 'lista-extraviadas', component: ListaExtraviadasComponent 
  },
  {
    path: 'lista-encontradas', component: ListaEncontradasComponent 
  },
  {
    path: 'mascotas-PorAdoptadarPerfil', component: MascotasPorAdoptarPerfilComponent 
  },
  {
    path: 'mascotas-EncontradasPerfil', component: MascotasEncontradasPerfilComponent
  },
  {
    path: 'mascotas-ExtraviadasPerfil', component: MascotasExtraviadasPerfilComponent
  },
  {
    path: 'mascotas-admin', component: MascotasComponent 
  },
  {
    path: 'mascotasPorAdoptar-admin', component: MascotasPorAdoptarAdminComponent
  },
  {
    path: 'mascotasEsterilizadas-admin', component: MascotasEsterilizadasComponent
  },
  {
    path: 'mascotasExtraviadas-admin', component: MascotasExtraviadasAdminComponent
  },
  {
    path: 'unidadMovil-admin', component: UnidadMovilAdminComponent
  },
  {
    path: 'perfil-mascota/:parametro', component: PerfilMascotaComponent 
  },
  {
    path: 'lista-postulados/:parametro', component: ListaPostuladosComponent 
  },
  {
    path: 'mascotasEncontradas-admin', component: MascotasEncontradasAdminComponent 
  },
  {
    path: 'contratos-admin', component: ContratosComponent
  },
  {
  ...
  {
    path: 'popupAgregarLogro/:parametro/:parametro2', component: PopupAgregarLogroComponent
  },
  {
    path: 'agregarLogro/:parametro/:parametro2', component: AgregarLogroComponent
  },
  {
    path: 'mascota-registro-alcaldia', component: MascotasRegistroAlcaldiaComponent
  },
  {
    path: 'reporte-completo', component: ReporteCompletoComponent
  },
  {
    path: 'mascota-list-alcaldia', component: MascotasListAlcaldiaComponent
  },
  {
    path: 'mascota-microChipPerfil', component: MascotasMicrochipComponent
  },
  {
    path: 'agregarLogroAdmin/:parametro/:parametro2', component: AgregraLogroAdminComponent
  },
   {
    path: 'editarUserPagina/:parametro/', component: EditarUserPaginaComponent
  },
  {
