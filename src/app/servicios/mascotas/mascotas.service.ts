...
import { PropietarioMascota } from "src/app/modelos/modulo-propietario/propietario-modulo";
...
export class MascotasService {
  ...
  getUsuarioAdoptadorPorIdMascota(idMascota: string): Observable<any[]> {
    return this.http.get<any[]>(
      this.url +
        "getPostulaciones_datosUsuarioAdoptador.php?idMascota=" +
        idMascota
    );
  }
  ...
  getUsuarioPorIdMascota(idMascota: string): Observable<any[]> {
    return this.http.get<any[]>(
      this.url + "getIdUsuarioPorIdMascota.php?idMascota=" + idMascota
    );
  }
  ...
  getIdMascotaPorIdUsuarioPostulaciones(identidad: string): Observable<any> {
    return this.http.get<any>(
      this.url +
        "getIdMascotaPorIdUsuarioPostulaciones.php?identidad=" +
        identidad
    );
  }

  //recoger idMascota mediante idUsuario en postulaciones
  getIdMascotaPorIdUsuarioPostulacionesAdoptadas(
    identidad: string
  ): Observable<any> {
    return this.http.get<any>(
      this.url +
        "getIdMascotaPorIdUsuarioPostulacionesAdoptadas.php?identidad=" +
        identidad
    );
  }
  ...
  getPropietarioMascotaId(idMascota: string): Observable<PropietarioMascota[]> {
    return this.http.get<PropietarioMascota[]>(
      this.url + "getPropietarioMascotaId.php?idMascota=" + idMascota
    );
  }
  ...
  getMascotasPorAdoptarTipo(
    tipo: string,
    municipio: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasPorAdoptarTipo.php?tipo=" +
        tipo +
        "&municipio=" +
        municipio
    );
  }
  getMascotasAdoptadasTipo(
    tipo: string,
    municipio: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasAdoptadasTipo.php?tipo=" +
        tipo +
        "&municipio=" +
        municipio
    );
  }
  getMascotasExtraviadasTipo(
    tipo: string,
    municipio: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasExtraviadasTipo.php?tipo=" +
        tipo +
        "&municipio=" +
        municipio
    );
  }
  getMascotasEncontradasTipo(
    tipo: string,
    municipio: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasEncontradasTipo.php?tipo=" +
        tipo +
        "&municipio=" +
        municipio
    );
  }
  getMascotasEsterilizadasTipo(
    tipo: string,
    municipio: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasEsterilizadasTipo.php?tipo=" +
        tipo +
        "&municipio=" +
        municipio
    );
  ...
  getMascotasPorFundacion(idFundacion: string): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url + "getMascotasPorFundacion.php?idFundacion=" + idFundacion
    );
  }

  getMascotasPorFundacionChip(idFundacion: string): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url + "getMascotasPorFundacionChip.php?idFundacion=" + idFundacion
    );
  }
  ...
  getMascotasPorFundacionAdoptadas(idFundacion: string): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasPorFundacionAdoptadas.php?idFundacion=" +
        idFundacion
    );
  }
  getMascotasPorFundacionPorAdoptadar(
    idFundacion: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasPorFundacionPorAdoptadar.php?idFundacion=" +
        idFundacion
    );
  }
  getMascotasPorFundacionEncontradas(
    idFundacion: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasPorFundacionEncontradas.php?idFundacion=" +
        idFundacion
    );
  }
  getMascotasPorFundacionExtraviadas(
    idFundacion: string
  ): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url +
        "getMascotasPorFundacionExtraviadas.php?idFundacion=" +
        idFundacion
    );
  }
  ...
  getMascotasPorIdUsuario(idUsuario: string): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url + "getMascotasPorIdUsuario.php?idUsuario=" + idUsuario
    );
  }
  //recoger datos mascota por chip
  getMascotasIdChip(idChip: string): Observable<Mascota> {
    return this.http.get<Mascota>(
      this.url + "getMascotasIdChip.php?numChip=" + idChip
    );
  }
  //get razas por id
  ...
  getIdMascota(idMascota: string): Observable<Mascota[]> {
    return this.http.get<Mascota[]>(
      this.url + "getIdMascota.php?idMascota=" + idMascota
    );
  }
  ...
  getCiudadId(idCiudad: string): Observable<Ciudad> {
    return this.http.get<Ciudad>(
      this.url + "getCiudadId.php?idCiudad=" + idCiudad
    );
  }
  ...
  //subir propietario mascota
  public subirPropietarioMascota(data): Observable<any> {
    let uploadURL = this.url + "addMascotaPropietario.php";
    return this.http.post<any>(uploadURL, data);
  }
  ...
  editarMascotaAdmin(mascota: Mascota): Observable<any> {
    ...
    console.log(options);
    return this.http.post(
      this.url + "updateMascotaPorAdmin.php",
      JSON.stringify(options),
      headers
    );
  }
