...
export class EventosService {
  ...
  getEventoById(idEvento: string): Observable<Eventos>{
    return this.http.get<Eventos>(this.urlEvento + 'getEventoById.php?idEvento=' + idEvento)
  }
  getEventosByMunicipio(municipio: string): Observable<Eventos[]>{
    return this.http.get<Eventos[]>(this.urlEvento + 'getEventoByMunicipio.php?municipio=' + municipio)
  }
  ...
  addEvento(evento:Eventos): void
  {
    ...
    options 	: any		= { "key" : "create", 
     ...
     "usuarioRegistro": evento.usuarioRegistro
         ...
         this.http.post(this.urlEvento + "addEvento.php", JSON.stringify(options), headers)
        .subscribe((data : any) =>
        {
          if(data.result=="ok"){
            this.resul=data;
   ...
   eliminarEvento(idEvento: string): Observable<any>{
       return this.http.get(this.urlEvento + 'deleteEvento.php?idEvento=' + idEvento); 
    }
