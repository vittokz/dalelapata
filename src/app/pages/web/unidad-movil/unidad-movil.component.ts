...
export class UnidadMovilComponent implements OnInit {
  ...
  totalExterilizaciones: UbicacionMapa[];
  ...
  getAllUbicaciones() {
    this.mapService.getAllUbicaciones().subscribe((data) => {
      this.listaLatitudes = data;
      console.log(this.listaLatitudes);
      this.listaLatitudes.map((item) => {
        this.totalEsterilizadas =
          this.totalEsterilizadas + Number(item.cantidad);
        console.log("totalEsterilizadas", this.totalEsterilizadas);
  ...
  activarMunicipio(evento) {
    ...
    this.mapService
      .getUbicacionesByIMunicipio(this.municipio)
      .subscribe((data) => {
  ...
  cargarUbicaciones() {
    this.mapService.getTotalExterilizaciones().subscribe((data) => {
      this.totalExterilizaciones = data;
      this.totalExterilizaciones.forEach((item) => {
        this.totalEsterilizadas =
          this.totalEsterilizadas + Number(item.cantidad);
      });
      console.log(this.totalEsterilizadas);
    });

    this.mapService.getUbicaciones().subscribe((data) => {
