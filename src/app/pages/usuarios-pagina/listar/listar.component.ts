...
export class ListarComponent implements OnInit {
  ...
  editarUsuario(data) {
    ...
    this.formEditar.get("clave").setValue(data.clave);
  }
  ...
  editar() {
    ...
    this.usuarioEditado.clave = frm.clave;
    this.userPlataformaService
      .actualizarUsuario(this.usuarioEditado)
      .subscribe((data) => {
        if (data["resul"] == 1) {
          this.editarForm = "ok";
        } else {
  ...
  cargarUsuario(identidad: string) {
    this.authService.getUsuarioPorIdentidad(identidad).subscribe((data) => {
      ...
      this.nombreCompleto =
        this.usuarioLogueado[0].nombre + " " + this.usuarioLogueado[0].apellido;
    });
  }

  cargarUsuarios() {
    this.userPlataformaService.getUsuarios().subscribe((data) => {
      this.usuario = data;
    });
  }
  ...
  verMascotasUsuario(data) {
    this.adopcionService
      .generaWordIdUsuarioIdMascota(data.idUsuario)
      .subscribe((dataMascota) => {
  ...
  generarWord(mascota: Mascota[], data) {
    let content =
      "<h3><center>INFORMACIÓN DE MASCOTA Y USUARIO</center></h3><center>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> Nombre: " +
      data.nombres +
      " " +
      data.apellidos +
      "</span><br>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> Identidad: " +
      data.identidad +
      "</span><br>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> Dirección: " +
      data.direccion +
      "</span><br>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> Movil: " +
      data.movil +
      "</span><br>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> Email: " +
      data.email +
      "</span><br>";
    content =
      content + "<h3><center>INFORMACIÓN DE LAS MASCOTAS</center></h3><center>";
    let i = 1;
    mascota.map((elemento) => {
      console.log("mascota:", elemento.nombre);
      console.log("mascota:", elemento.numChip);
      content =
        content + "<h3><center>Mascota N." + i + "</center></h3><center>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Nombre: " +
        elemento.nombre +
      ...
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> NumChip: " +
        elemento.numChip +
        "</span><br>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Edad: " +
        elemento.edad +
        "</span><br>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Especie: " +
        elemento.idEspecie +
        "</span><br>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Genero: " +
        elemento.idGenero +
        "</span><br>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Tamaño: " +
        elemento.tamano +
        "</span><br>";
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Peso: " +
        elemento.peso +
        "</span><br>";
      content =
        content +
      ...
      content =
        content +
        "<span style='font-size:13px; font-weight:800'> Fecha Registro: " +
        elemento.fechaRegistro +
        "</span><br>";
      content =
        content +
        "<img style='width:40px;height:50px; display:block; margin:auto;' src='" +
        this.url +
        elemento.urlFoto +
        "'><br>";
      i++;
    ...
    content =
      content +
      "<br><br><br><span style='font-size:13px; font-weight:800'> Generado Por: " +
      this.nombreCompleto +
      "</span><br>";
    ...
    htmlDocumennt =
      htmlDocumennt + "</head><body>" + content + "</body></html>";
  ...
  generarWord2(data) {
    ...
    content =
      ...
      "</span><br>";
    content =
      content + "<h3><center>INFORMACIÓN DE LA MASCOTA</center></h3><center>";
    content =
      content +
      "<span style='font-size:13px; font-weight:800'> El Usuario no tiene ninguna información relacionada con mascotas!!!</span><br>";
    content =
      content +
      "<br><br><br><span style='font-size:13px; font-weight:800'> Generado Por: " +
      this.nombreCompleto +
