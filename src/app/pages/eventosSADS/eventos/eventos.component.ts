...
export class EventosComponent implements OnInit {
  ...
  constructor(private authService: AuthUsuariosService,private exportExcelService: ExportarService,
    private eventoService: EventosService, private ruta: Router) { }
  ...
  cargarEventos(municipio: string){
    this.eventoService.getEventosByMunicipio(municipio).subscribe(
      (resul)=>{
        this.evento = resul;
