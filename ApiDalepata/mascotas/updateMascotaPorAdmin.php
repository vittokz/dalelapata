<?php
    ...
    $observacion	  = filter_var($obj->observacion, FILTER_SANITIZE_STRING, FILTER_FLAG_ENCODE_LOW);
    
   date_default_timezone_set('America/Bogota');
    $hoy = date("Y-m-d g:i a");         
    try {
        $stmt 	= $pdo->query("UPDATE dlp_mascota set numChip='$chip',idFundacion='$idFundacion',
        nombre='$nombre', edad='$edad', descripcion='$descripcion', observacion = '$observacion', idRaza='$idRaza',
